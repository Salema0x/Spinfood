...
class ParticipantFactoryTest {
    ...
    void readCSV() throws URISyntaxException {
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste0.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste1.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste2.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste3.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste4.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste5.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste6.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste7.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste8.csv")).toURI()));
        ...
        //testing isSuccessor
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste9.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(getClass().getResource("/testlists/participantfactorytestlists/testliste10.csv")).toURI()));
