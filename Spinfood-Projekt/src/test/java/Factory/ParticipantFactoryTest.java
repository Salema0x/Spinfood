...
class ParticipantFactoryTest {
    ...
    void readCSV() throws URISyntaxException {
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(ClassLoader.getSystemResource("testlists/ParticipantFactoryTestlists/testliste0.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(ClassLoader.getSystemResource("testlists/ParticipantFactoryTestlists/testliste1.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(ClassLoader.getSystemResource("testlists/ParticipantFactoryTestlists/testliste2.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(ClassLoader.getSystemResource("testlists/ParticipantFactoryTestlists/testliste3.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(ClassLoader.getSystemResource("testlists/ParticipantFactoryTestlists/testliste4.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(ClassLoader.getSystemResource("testlists/ParticipantFactoryTestlists/testliste5.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(ClassLoader.getSystemResource("testlists/ParticipantFactoryTestlists/testliste6.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(ClassLoader.getSystemResource("testlists/ParticipantFactoryTestlists/testliste7.csv")).toURI()));
        ...
        participantFactory.readCSV(new File(Objects.requireNonNull(ClassLoader.getSystemResource("testlists/ParticipantFactoryTestlists/testliste8.csv")).toURI()));
