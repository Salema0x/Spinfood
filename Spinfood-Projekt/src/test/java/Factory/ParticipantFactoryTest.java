...
class ParticipantFactoryTest {
    ...
    void readCSV() throws URISyntaxException {
        ...
        expectedParticipantList0.add(new Participant(new String[] {"0", "004670cb-47f5-40a4-87d8-5276c18616ec", "Person1", "veggie", "21", "male", "maybe", "3.0", "8.673368271555807", "50.5941282715558"}));
        expectedParticipantList0.add(new Participant(new String[] {"1", "01a099db-22e1-4fc3-bbf5-db738bc2c10b", "Person2", "none", "26", "male", "yes", "1.0", "8.718914539788807", "50.590899839788804"}));
        ...
        expectedParticipantList1.add(new Participant(new String[] {"2", "01be5c1f-4aa1-458d-a530-b1c109ffbb55", "Person3", "vegan", "22", "male", "yes", "0", "8.681372017093311", "50.5820794170933"}));
        ...
        expectedParticipantList2.add(new Participant(new String[] {"2", "01be5c1f-4aa1-458d-a530-b1c109ffbb55", "Person3", "vegan", "22", "male", "yes", "0", "-1.0", "-1.0"}));
        ...
        expectedParticipantList3.add(new Participant(new String[] {"2", "01be5c1f-4aa1-458d-a530-b1c109ffbb55", "Person3", "vegan", "22", "male", "yes", "4.0", "-1.0", "-1.0"}));
