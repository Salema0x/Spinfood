...
public class JsonExportTest {
    ...
    public void testJsonExport() {
        ...
        //Act
        JsonExport jsonExport = new JsonExport(dinnerRoundsList, registeredPairsList, successorPairsList, successorParticipantsList);

        //Assert
        Assertions.assertTrue(Paths.get("src/main/resources/JsonExport.json").toFile().exists());
    }
